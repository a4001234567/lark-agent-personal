...
ule_list.append((contain_constructor('主楼'),(117.171265,39.102205)))
...
rule_list.append((contain_constructor('八里台东艺'),(117.173090,39.102723)))
rule_list.append((contain_constructor('八里台学活'),(117.163655,39.105843)))
rule_list.append((contain_constructor('八里台数学'),(117.163732,39.103951)))
rule_list.append((contain_constructor('逸夫馆'),(117.165930,39.102992)))
rule_list.append((contain_constructor('八里台省身楼'),(117.170356,39.101202)))
rule_list.append((contain_constructor('八里台高层'),(117.162516,39.103443)))
rule_list.append((contain_constructor('八里台方楼'),(117.16189442396558,39.10304101184789)))
rule_list.append((contain_constructor('八里台圆阶'),(117.162548,39.102630)))
rule_list.append((contain_constructor('八里台天南楼'),(117.175229,39.105985)))
rule_list.append((contain_constructor('范孙'),(117.166332,39.102110)))
rule_list.append((contain_constructor('八里台商学院'),(117.156327,39.105003)))
rule_list.append((contain_constructor('八里台汉院'),(117.173408,39.102140)))
rule_list.append((contain_constructor('八里台体育中心游泳馆','八里台游泳馆'),(117.17424266623686, 39.105546158316386)))
rule_list.append((contain_constructor('八里台体育中心','八里台击剑室','八里台新馆'),(117.17339135758766,39.1052733199941)))
rule_list.append((contain_constructor('八里台体育馆','八里台老馆','八里台1号馆','八里台2号馆'),(117.17175251255549, 39.10550860070567)))
rule_list.append((contain_constructor('八里台足球场'),(117.17038770568251, 39.10530434268972)))
rule_list.append((contain_constructor('八里台网球场'),(117.1709601628761,39.1056050153414)))
rule_list.append((contain_constructor('八里台滑冰场'),(117.17221925016236,39.1059885144077)))
rule_list.append((contain_constructor('风雨操场'),(117.16171567708443,39.10428710728575)))
rule_list.append((contain_constructor('八里台蒙民伟楼','高分子化学研究所'),(117.17629794953905,39.102064137502815)))
...
rule_list.append((contain_constructor('津南理科网球场','津南理科足球场'),(117.33941043447555,38.98568212917906)))
rule_list.append((contain_constructor('津南文科篮球场','津南文科网球场'),(117.34573667856966,38.99239653631121)))
rule_list.append((contain_constructor('津南足球场','跑廊','津南击剑教室'),(117.34998452136199, 38.99219035081378)))
rule_list.append((contain_constructor('旅游学院'),(117.33811037448788,38.990943187586396)))
rule_list.append((contain_constructor('哲学院'),(117.34422172000438,38.99069416518362)))
rule_list.append((contain_constructor('计算机学院'),(117.34227278302058,38.986566687285986)))
rule_list.append((contain_constructor('大通中心','大通'),(117.35029619662328,38.988269940762855)))
rule_list.append((contain_constructor('历史学院'),(117.34359499967718,38.9912159830328)))
rule_list.append((contain_constructor('秀山堂'),(117.34010037556618,38.989029524030116)))
rule_list.append((contain_constructor('周政学院'),(117.34258125852716,38.99143180677019)))
rule_list.append((contain_constructor('金融学院'),(117.3435074001892,38.99029371616919)))
rule_list.append((contain_constructor('津南汉院'),(117.34162883062754,38.990688558846955)))
rule_list.append((contain_constructor('环科楼','环科院楼'),(117.33740853652705,38.989339161524214)))
rule_list.append((contain_constructor('津南医学院'),(117.33686959144165,38.98708241489288)))
rule_list.append((contain_constructor('津南体育馆'),(117.3475785502618,38.991931833659834)))
rule_list.append((contain_constructor('津南药学院'),(117.33764342990821,38.98785571917332)))
rule_list.append((contain_constructor('电光学院'),(117.34144379297015,38.987139246478385)))
rule_list.append((contain_constructor('中心馆','津南图书馆'),(117.346951708436,38.986331943903124)))

rule_list.append((contain_constructor('泰达'),(117.71409599813819,39.02611400865321)))

rule_list.append((contain_constructor('儿童医院'),(117.19944572379666,39.10066448273102)))
rule_list.append((contain_constructor('983医院'),(117.19087057260413,39.16171479715551)))
rule_list.append((contain_constructor('中心妇产医院'),(117.172485726128,39.126763001512224)))
rule_list.append((contain_constructor('人民医院'),(117.14686701834341,39.14736613773112)))
rule_list.append((contain_constructor('口腔医院'),(117.20612087912832,39.12770380374977)))
rule_list.append((contain_constructor('一中心医院'),(117.15199378739248,39.10113402370789)))
rule_list.append((contain_constructor('眼科医院'),(117.18510599724539,39.12448101333313)))

rule_list.append((contain_constructor('津南操场1'),(117.34998452136199, 38.99219035081378)))
rule_list.append((contain_constructor('操场1'),(117.17038770568251, 39.10530434268972)))
